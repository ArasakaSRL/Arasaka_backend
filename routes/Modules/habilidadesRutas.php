...
Route::prefix('portafolios')->group(function () {
    ...
    Route::get("{idPortafolio?}/habilidades", [HabilidadController::class, "index"])->middleware('auth:sanctum')->name('habilidades.index');   
    Route::post("{idPortafolio?}/habilidades", [HabilidadController::class, "store"])->middleware('auth:sanctum')->name('habilidades.store');
